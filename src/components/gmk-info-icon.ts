...
export class GmkInfoIcon extends HTMLElement {
    ...
    constructor() {
        ...
        this.attachShadow({mode: 'open'}).innerHTML = html`
            ...
            <a id="infoButton" aria-label="${page?.replace(/[-_]/g, ' ') ?? ''}">
                <svg viewBox="0 0 100 100" style="width: ${innerSize}px; height: ${innerSize}px">
        ...
        if(page){
            comp(this, '#infoButton')().setAttribute('href', `/${page}`);
        }
    }
